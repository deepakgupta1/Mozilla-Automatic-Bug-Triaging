...
for train_index, test_index in skf.split(train, y):
    ...
    model.save_weights('model_attention_glove_' + str(ifold) + '.h5')
...
submit.to_csv('submit_attention_glove.csv', index=False)

np.savetxt('attention_glove', predict, delimiter=',', fmt = '%0.6f')