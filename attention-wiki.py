...
for train_index, test_index in skf.split(train, y):
    ...
    model.save_weights('model_attention_wiki_small' + str(ifold) + '.h5')
...
submit.to_csv('submit_attention_wiki_small.csv', index=False)

np.savetxt('attention_wiki_small', predict, delimiter=',', fmt = '%0.6f')